...
The results, presented in Figure \ref{fig:loocv_robustness}, demonstrate the stability of our conclusions. The AUROC scores are tightly clustered around the baseline model's performance, with a mean of 0.5272 and a standard deviation of just 0.0094. This narrow distribution confirms that the informational content of SVD—and its limitations as an unconditional predictor—is a robust, market-wide phenomenon. The signal is genuinely cross-sectional and not an artifact of any single sector's variance.
